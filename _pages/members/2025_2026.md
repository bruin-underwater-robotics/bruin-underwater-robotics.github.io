---
title: "Members (2025-2026)"
layout: small_banner
permalink: /members/2025-2026
...
<div class="bur-members" markdown="0">
  <section class="bur-wide-container">
    {% for category in site.data.members.2025_2026 %}
  ...
  <section class="bur-wide-container">
    ...
    {% for category in site.data.members.2025_2026 %}
        {% if category.type == "subteam" and category.id != "Hardware" %}
        <div class="row bur-subteam-row">
